...
echo 32-bit Installer for downloading, updating, and pre-installing Office 365
echo By Deep Six Security
echo www.deepsixsecurity.com
echo.
echo Do not run this from a network location (Samba,Windows Share Drive).
echo ---
...
pause
OfficeDeploy.exe /download configuration32.xml
...
pause
OfficeSetup.exe /configure configuration32.xml
echo.
